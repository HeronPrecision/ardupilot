...
#define BOARD_NAME        HERONPRECISION_CHICKADEE
...
// #define MAG_I2C_ADDRESS 0x14
#define USE_BARO
// #define USE_BARO_ICP201XX
#define USE_BARO_SPI_ICP201XX
// #define DEFAULT_BARO_SPI_ICP201XX

// Enable USB CDC debug mode - disables MSP on USB for raw sensor debug output
// Comment out the line below to use normal MSP mode on USB
// #define USE_USB_CDC_DEBUG
#define USE_MAX7456
...
#define BOX_USER1_NAME "CAMERA SELECTOR"
