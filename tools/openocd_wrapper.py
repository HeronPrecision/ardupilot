...
class OpenOCDWrapper:
    ...
    def __init__(self, config_file=None, log_file=None, debug=False):
        ...
        if not Path(self.config_file).exists():
            raise FileNotFoundError(f"OpenOCD config file not found: {self.config_file}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="OpenOCD Wrapper with Timeout Handling")
